        ...
        <section className="min-h-screen bg-[var(--background)]">
            ...
            <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 md:py-32">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-8 text-sm sm:text-base md:text-lg font-medium text-[var(--muted-foreground)] relative">
                    ...
                    >
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block align-middle sm:w-10 sm:h-10"><circle cx="12" cy="12" r="10" fill="#7F0B06" /><text x="12" y="16" textAnchor="middle" fontSize="10" fill="white" fontFamily="Arial" fontWeight="bold">GW</text></svg>
